...
ssh "$SERVER" "cd $REMOTE_PATH && source venv/bin/activate && python scripts/add_tokens_acesso.py 2>/dev/null || true && python scripts/add_feriado_cardapio.py 2>/dev/null || true && python scripts/add_editado_por_cardapio.py 2>/dev/null || true && python scripts/add_rh_tables.py 2>/dev/null || true && python scripts/add_ponto_almoco.py 2>/dev/null || true && python scripts/add_data_pagamento.py 2>/dev/null || true"
